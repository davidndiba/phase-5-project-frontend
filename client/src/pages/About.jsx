...
import VolunteerForm from "../ui/VolunteerForm";
      ...
      <div className="image_grid">
        ...
        <div className="image_row">
          <div className="image_with_text">
            ...
            <Link to="/volunteer"> {/* Updated route to link to the VolunteerForm */}
              <img
          ...
          <div className="image_with_text">
            ...
            <Link to="/donations"> {/* Updated route to link to the Donations page */}
              <img
